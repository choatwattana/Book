...
Button(m, text="/", command=lambda: press("/")).grid(row=2, column=3, sticky="news")
...
Button(m, text="*", command=lambda: press("*")).grid(row=3, column=3, sticky="news")
...
Button(m, text="-", command=lambda: press("-")).grid(row=4, column=3, sticky="news")
Button(m, text="0", command=lambda: press("0")).grid(row=5, column=0)
Button(m, text=".", command=lambda: press(".")).grid(row=5, column=1, sticky="news")
Button(m, text="%", command=lambda: press("%")).grid(row=5, column=2)
